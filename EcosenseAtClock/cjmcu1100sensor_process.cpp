...
CJMCU1100SensorProcess::CJMCU1100SensorProcess(IProcessMessage* msg) : MQSensorProcess(msg){
...
IProcessMessage* CJMCU1100SensorProcess::getResultMsg() {
	...
	return new AirQualityMsg(AirQualityMsg::GasType::VOCs, AirQualityMsg::value2code(byte(expf( logPPM ))), logPPM);
